...
public class Main {
	...
	CreateCodeMakerToolPanel();
		...
		public static void ToolPanelTopRight(){
			 ...
			 JLabel KolaLabel1 = new JLabel("<html><center><H1>Kola Pattern Generator </H1><br><H2'>Version 0.2  <br>Created by:  <br>Peter Black & Max Claus  <br>Licensed using GPL v 3.0  <br> Kola Industries LLC</html>");
